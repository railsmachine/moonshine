...
class MoonshineGenerator < Rails::Generators::Base
  ...
  class_option :ruby, :default => default_ruby, :desc => 'Ruby version to install. Currently supports: src193, src193falcon, src193railsexpress, src200, src200railsexpress, src21, src21railsexpress, src22, src23, src24, src25, src26', :type => :string
